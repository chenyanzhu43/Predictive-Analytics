...
```{r wkdir}
set.seed(0)
setwd("C://Users//jessm//OneDrive//Documents//Columbia University//Fall 2019//STAT 5243 - Applied Data Science//Projects//Project 3//Project 3 - Final Submission//doc")
...
```{r}
train_dir <- "..//data//test_set_sec2//test_set_sec2/" # This will be modified for different data sets.
...
colnames(dat_testBaseline)[6006] = 'feature6006'
...
colnames(dat_test)[3003] = 'feature3003'
...
res = cbind(as.numeric(predictionGBM),as.numeric(predictionSVM))
baseLineAndOurModel = as.data.frame(res)
colnames(baseLineAndOurModel) = c('baseline','final_model')
write.csv(baseLineAndOurModel, file = "../output/baseLineAndOurModel.csv")
